...
class _AdaptiveAttention(nn.Module):
    ...
    def __init__(self, classes, n_head, attention_type, shot_mode, n_way=2, n_shot=5, pos_encoding=True):
        super(_AdaptiveAttention, self).__init__()
...
class AAARCNN(_AdaptiveAttention):
    def __init__(self, classes, n_head, attention_type, shot_mode, num_layers=50, pretrained=False, num_way=2, num_shot=5, pos_encoding=True):
        ...
        _AdaptiveAttention.__init__(self, classes, n_head, attention_type, shot_mode, n_way=num_way, n_shot=num_shot, pos_encoding=pos_encoding)
