...
class VOCFSLoader(data.Dataset):
    def __init__(self, imdb, roidb, ratio_list, ratio_index, support_dir,
        ...
        voc_name_to_coco_name = {'aeroplane':'airplane', 'bicycle':'bicycle', 'bird':'bird', 'boat':'boat', 'bottle':'bottle', 'bus':'bus', 
        'car':'car', 'cat':'cat', 'chair':'chair', 'cow':'cow', 'diningtable':'dining table', 'dog':'dog', 'horse':'horse', 'motorbike':'motorcycle', 
        'person':'person', 'pottedplant':'potted plant', 'sheep':'sheep', 'sofa':'couch', 'train':'train', 'tvmonitor':'tv'}
        ...
        for _label in range(1, self._num_classes):
            ...
            cls_name = voc_name_to_coco_name[cls_name]
